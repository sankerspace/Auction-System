...
public class AESwithHMACException extends Exception {
    
    public AESwithHMACException(){ }
    public AESwithHMACException(String s){super(s); }
    /*
     ...
     */
    public AESwithHMACException(String s,Throwable cause){super(s,cause); }
