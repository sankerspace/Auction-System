...
public class EasySignatureException extends Exception {
    
    public EasySignatureException(){ }
    public EasySignatureException(String s){super(s); }
    /*
     ...
     */
    public EasySignatureException(String s,Throwable cause){super(s,cause); }
