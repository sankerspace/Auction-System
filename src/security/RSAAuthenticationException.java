 ...
 * @author sanker
 */
public class RSAAuthenticationException extends Exception {
    
    public RSAAuthenticationException(){ }
    public RSAAuthenticationException(String s){super(s); }
    /*
     ...
     */
    public RSAAuthenticationException(String s,Throwable cause){super(s,cause); }
